...
const DEFAULTS = {
  ...
  comfyui_neg_default:   'extra limbs, extra fingers, fused fingers, missing fingers, malformed hands, bad hands, extra arms, extra legs, bad anatomy, bad proportions, deformed, mutated, disfigured, ugly, bad face, blurry, low quality, worst quality, watermark, text, signature, anime, cartoon, illustration, 3d render, futa, futanari',
  comfyui_steps:         '',
  comfyui_cfg:           '',
  comfyui_guidance:      '',
  comfyui_sampler:       '',
  ...
  llm_max_tokens:         '400',
  llm_prompt_words:       '150',
  llm_raw_output:         'false',
  llm_allow_toys:         'false',
  llm_ollama_params:      'true',
};
